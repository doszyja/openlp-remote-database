...
function splitVersesString(versesString: string | undefined): Array<{ order: number; content: string; label: string | null }> {
...
function combineVersesToString(verses: Array<{ order: number; content: string; label?: string | null }>): string {
  return verses
...
describe('Verse Helpers', () => {
  ...
  describe('combineVersesToString', () => {
    ...
    it('should handle single verse', () => {
      const verses = [
        { order: 1, content: 'Single verse', label: null },
      ];
